...
{
    public class OledbSqlGenerator : SqlGenerator
    {
        ...
        {
            return base.FormatParameterList(columnNames,DEFAULT_PARAMETER_PREFIX_SIGN);
        }
        ...
        {
            return FormatColumnAndParameterPairs(columnNames, DEFAULT_PARAMETER_PREFIX_SIGN);
        }
