...
namespace Jasen.Framework
{
    ...
    public class SqlServerSqlBuilder : SqlBuilder
    {
        ...
        {
            return base.FormatParameterList(columnNames, DatabaseType.SqlServer);
        }

        /// <summary>
        /// MYSQLÖ§³ÖCASE WHEN THEN VALUE1 ELSE VALUE2 END
        /// </summary>
        ...
        {
            return FormatColumnAndParameterPairs(columnNames, DatabaseType.SqlServer);
        }
        ...
        public string SelectPaging2000(Type entityType, string condition, int pageSize, int pageIndex,
